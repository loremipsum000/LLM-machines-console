...
| PR-12 source closure | Deterministic Core release packaging and per-delivery inference artifact contracts | `pr-12-aggregate-evidence.json`, `pr-12-source-closure.json`, and source-closure Amendments 1 through 3 | PR 33 through PR 39 and Amendment 1 remain immutable evidence. Amendment 2 remains immutable evidence. PR 53 remains protected functional history. PR 54 repaired the stale Firecrawl API build-test list, and PR 55 corrected only the unavailable immutable Node API build input and regenerated the Firecrawl source-packet evidence. PR 55 merged at `059866dc07dbc2af95df84ee834fca598a9a64a9`, tree `f14535be105e8073668c922e306a317bed55b993`. Amendment 3 binds the exact PR 54 and PR 55 topology and that final merge as the current D2A release source. The earlier `4b2fc6a` release source is historical, not current. Accepted remains false; runtimeQualified remains false; contract activation remains inactive; D2A-RC and Q0 remain NOT_STARTED; Product main is unchanged |
