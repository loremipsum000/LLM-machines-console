...
| PR-11A R1-H1 | Repository-wide Biome hygiene successor | `pr-11a-r1-h1-hygiene-decisions.json` | Source candidate awaiting full detached validation and independent review; no product or runtime behavior change; PR-11A remains unaccepted, not revision-bound, and not runtime-qualified |
