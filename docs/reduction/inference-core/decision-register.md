...
| PR-11A R1-D1 | Storage, backup, retention, and recovery | `pr-11a-r1-d1-storage-recovery-decisions.json` | Source candidate awaiting independent review; unaccepted, not revision-bound, and not runtime-qualified |
