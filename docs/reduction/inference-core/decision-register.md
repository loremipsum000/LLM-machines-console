...
| PR-11A R1-D1 | Storage, backup, retention, and recovery | `pr-11a-r1-d1-storage-recovery-decisions.json` | Independently reviewed source candidate at `46295906c3d733b0e56abe94d9732d8eb0549c29`; unaccepted, not revision-bound, and not runtime-qualified |
