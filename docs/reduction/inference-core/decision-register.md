...
| PR-11A R1-D1 | Storage, backup, retention, and recovery | `pr-11a-r1-d1-storage-recovery-decisions.json` | Admitted source-incomplete package; unaccepted, not revision-bound, and not runtime-qualified |
