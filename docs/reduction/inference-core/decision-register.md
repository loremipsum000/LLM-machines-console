...
| PR-11A R1-V1 successor | Aggregate source closure from exact post-H1 integration input | `pr-11a-r1-v1-aggregate-evidence.json` and unaccepted `contract-revisions/PR-11A.json` candidate | Source candidate validation pending; active reviewed revision remains PR-11; PR-11A remains unaccepted and not revision-bound; Q0 remains unstarted; PR-12 remains unstarted |
