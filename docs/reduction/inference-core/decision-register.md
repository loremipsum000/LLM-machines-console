...
| PR-11A R1-K1 | Signing custody and public trust | `pr-11a-r1-k1-signing-custody-decisions.json` | Admitted from integration commit `1743cb746f87c7497a34f4de7e3bfc0db3ff0be2`; source incomplete, unaccepted, not revision-bound, and not runtime-qualified |
