...
| PR-11A R1-C0 | Product authority and governance correction | `pr-11a-identity-ingress-hardening-decisions.json` | Proposed governance checkpoint only; unaccepted and not revision-bound |
