...
| PR-11A R1-E1 | Mandatory core Product edge | `pr-11a-r1-e1-product-edge-decisions.json` | Governance checkpoint only; source is incomplete, unaccepted, and not revision-bound |
