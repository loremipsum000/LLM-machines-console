...
| PR-11A R1-E1 | Mandatory core Product edge | Governance checkpoint only; edge source, source validation, independent review, aggregate R1-V1, and Q0 runtime qualification remain pending; PR-11A is unaccepted and not revision-bound |
