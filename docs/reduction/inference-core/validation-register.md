...
| PR-11A R1-D1 | Storage, backup, retention, and recovery | Admitted source-incomplete; source, fresh-clone, independent review, aggregate R1-V1, and Q0 runtime qualification remain pending; PR-11A is unaccepted and not revision-bound |
