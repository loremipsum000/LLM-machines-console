...
| PR-11A R1-C0 | Product authority and governance correction | Not accepted; governance checkpoint only; behavior, package review, merge, and R1-V1 revision remain pending |
