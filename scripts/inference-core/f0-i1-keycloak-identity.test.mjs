...
test("F0-I1 remains a bounded disposable Keycloak identity proof", async () => {
  ...
  assert.match(wrapper, /browserFlow: "llm-machines-browser-password"/)
  assert.match(wrapper, /authenticator: "auth-username-password-form"/)
  assert.doesNotMatch(wrapper, /otpPolicyAlgorithm/)
